...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+880) 1607 150 462",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "iamhanif101@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    ...
    >
      <div className="container mx-auto">
        <div className="flex flex-col gap-8 lg:flex-row">
          {/* form */}
          <div className="order-2 lg:w-[54%] lg:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className=" text-white/60">
                ...
                Aliquid impedit id vel nulla magnam?
              </p>
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="gst">Logo Design</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              {/* text area */}
